...
describe("background", () => {
  ...
  // image
  it("background-image:none", () => { expect(generator("background-image:none")).toBe("bg-none") })
  it("background-image:url('picture.png')", () => { expect(generator("background-image:url('picture.png')")).toBe("bg-[url('picture.png')]") })
})